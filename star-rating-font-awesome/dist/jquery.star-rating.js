    ...
    $.fn.starRating = function (setup) {
        ...
        function init(wrapper) {
            if (!wrapper.hasClass('js-wc-star-rating')) {
                ...
                let starWrapper = $('<div>', {
                    css: {'display': 'flex', 'gap':'5px', 'flex-wrap': 'nowrap'}
                }).appendTo(wrapper);
            ...
            function events(wrapper) {
                wrapper
                    .on('click', 'i', function (e) {
                        ...
                        if (settings.showInfo) {
                            wrapper.find('.js-wc-rating-value').empty().append($(`<i class="fa-solid faIcon" style="font-size:46px; height: 46px; width: 46px; color:red !important;"></i>`));
